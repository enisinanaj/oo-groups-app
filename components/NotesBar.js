        ...
        <View style={styles.container}>
            <TouchableOpacity style={{flexDirection:'column', justifyContent: 'center', padding:10,}}>
                <View style={{flexDirection: 'row', justifyContent: 'flex-start'}}>
                    ...
                    <Text style={{fontSize:11, marginLeft: 5, color: Colors.lighterText}}>NOTES</Text>
                </View>
            </TouchableOpacity>
            <ScrollView style={styles.notes} horizontal={true} bounces={false} pagingEnabled={true}>
                <View style={styles.slide}>
                    <View style={styles.slideInnerContainer}>
                        ...
                        <Image
                            source={{ uri: 'https://ae01.alicdn.com/kf/HTB1TM7AQFXXXXcuXFXXq6xXFXXXh/2017-Juventus-fitness-T-Shirt-3d-printed-t-shirts-men-women-Long-sleeve-tumblr-t-Shirt.jpg_640x640.jpg' }}
                ...
                <View style={styles.slide}>
                    <View style={styles.slideInnerContainer}>
                        ...
                        <Image
                            source={{ uri: 'https://www.musicolandia.it/2480-large_default/accendino-a-petrolio-tristar-mod-football---juventus-3-stars.jpg' }}
                            style={{ height: itemHeight, width: itemWidth, marginTop: 10 }}
                        />
                    </View>
                </View>
