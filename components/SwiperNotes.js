  ...
  return (<View style={styles.slide}>
    <Image onLoad={props.loadHandle.bind(null, props.i)} style={styles.image} source={{uri: props.uri}} />
    {
      !props.loaded && <View style={styles.loadingView}>
        <Image style={styles.loadingImage} source={{uri:'https://gitlab.pro/yuji/demo/uploads/d6133098b53fe1a5f3c5c00cf3c2d670/DVrj5Hz.jpg_1'}} />
      </View>
    }
  </View>)
}

export default class SwiperNotes extends Component {
  constructor (props) {
    super(props)
    this.state = {
      imgList: [
